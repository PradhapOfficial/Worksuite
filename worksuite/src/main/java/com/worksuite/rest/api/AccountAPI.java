...
public class AccountAPI {
	...
	public UserPOJO getAccountDetails(@QueryParam("emailId") String emailId, @QueryParam("password") String password) throws Exception{
		try {
	...
	public UserPOJO addAccountDetails(String jsonStr) {
		try {
			...
			UserPOJO userPojo = new UserPOJO(jsonObject)
					.setEmailId(accountsPojo.getEmailId());
